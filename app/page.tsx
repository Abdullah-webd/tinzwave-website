          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
              <Button
                asChild
                size="lg"
                className="bg-primary text-primary-foreground hover:bg-primary/90 text-lg px-8 py-6 h-auto font-semibold transition-all hover:scale-105 hover:shadow-lg"
              >
                <Link href="/contact">
            ...
            {/* Stats */}
            <section className="md:bg-gradient-to-r from-primary/5 via-primary/10 to-primary/20 p-8">
      ...
      <section className="py-24 relative overflow-hidden bg-gradient-to-br from-primary to-primary">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-xl text-primary-foreground/90 mb-10 max-w-2xl mx-auto leading-relaxed">
            Join thousands of individuals and organizations building the future
            through technology
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              asChild
              size="lg"
              className="bg-primary text-primary-foreground hover:bg-primary/90 text-lg px-8 py-6 h-auto font-semibold hover:scale-105 transition-all"
            >

        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-primary-foreground/90 leading-relaxed mb-8">
              We exist because we believe that technology should be accessible
              to everyone in Africa. Too many businesses struggle without modern
              digital tools, and too many talented individuals lack access to
              quality tech training. Tinzwave bridges these gaps by providing
              affordable, world-class technology solutions and training that
              empowers African organizations and youth to compete globally.
            </p>
            <p className="text-lg text-primary-foreground/90 leading-relaxed">
              Our purpose is to transform Africa's digital landscape—one
              solution, one student, one organization at a time. We're not just
              building technology; we're building the future of Africa.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            {reasons.map((reason, index) => (
              <Card
                key={index}
                className="transition-all hover:shadow-lg hover:border-secondary border-2"
              >
                <CardContent className="p-6">
            ...
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-sm font-semibold text-primary-foreground/80 mb-2">
                    {member.title}
                  </p>

...
export const courses: Course[] = [
  ...
  },
  {
    ...
    overview:
      "Become a cybersecurity professional and learn to protect systems from cyber threats. Master ethical hacking, penetration testing, and security best practices.",
    whatYouLearn: [
  ...
  },
  {
    ...
    overview:
      "Learn to automate software delivery and infrastructure management. Master DevOps tools and practices used by leading tech companies.",
    whatYouLearn: [
    ...
    tools: ["Docker", "Kubernetes", "Jenkins", "Git", "AWS", "Terraform", "Ansible"],
    whoShouldEnroll: [
      "Software developers",
